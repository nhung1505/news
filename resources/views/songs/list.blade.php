        ...
        <table class="table table-striped">
            ...
            @else
                @foreach($songs as $key=>$song)
                    ...
                    <tr>
                        <td>{{++$key}}</td>
                        <td class="edit-width"><img class="img-rounded song-cover-img-large"
                                                    src="{{asset('storage/'.$song->image)}}"/></td>
                        ...
                        <td>
                            <form action="{{route('song.delete',$song->id)}}" method="post">
                                {{ csrf_field() }}
                                <button data-toggle="modal" data-target="#myModal-{{$song->id}}" type="button"
