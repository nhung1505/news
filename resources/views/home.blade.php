...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="/css/css/jplayer.blue.monday.min.css" rel="stylesheet">
    <!-- jQuery -->
    <!-- lined-icons -->
    <link rel="stylesheet" href="/css/css/icon-font.css" type='text/css' />
    <!-- //lined-icons -->
    <!-- Meters graphs -->
        ...
        <div class="header-section">
            ...
            <div class="menu-right">
                <div class="profile_details">
                    ...
                    <script src="js/js/uisearch.js"></script>
                    <script>
                    ...
                    <div class="col-md-4 player">
                        ...
                        <!--audio-->
                        <link rel="stylesheet" type="text/css" media="all" href="css/css/audio.css">
                        <script type="text/javascript" src="js/js/mediaelement-and-player.min.js"></script>
                        <!---->
            ...
            <div class="inner-content">
                ...
                <div class="music-left">
                    ...
                    <div class="albums">
                        ...
                        <div class="col-md-3 content-grid" style=" margin-right: 1%">
                            <div class="play-icon popup-with-zoom-anim" href="#small-dialog">
                                <img src="{{asset('storage/'.$song->image)}}" title="allbum-name">
                            </div>
                            <a class="button play-icon popup-with-zoom-anim-i" href="#small-dialog">{{$song->name}}</a>
                        </div>
                        @endforeach
                        <div class="clearfix"> </div>
                    </div>
                    <div class="albums second ">
                        ...
                        @foreach($albums as $album)
                            <div class="col-md-3 content-grid" style=" margin-right: 1%">
                                <div class="play-icon popup-with-zoom-anim"><a href="single.html"><img src="{{asset('storage/'.$album->image)}}" title="allbum-name"></a></div>
                                <div class="inner-info"><a href="single.html"><h5>{{$album->name}}</h5></a></div>
                            </div>
                        @endforeach
                        <div class="clearfix"> </div>
                    </div>
                ...
                <div class="music-right">
                    ...
                    <link href="css/css/jplayer.blue.monday.min.css" rel="stylesheet" type="text/css">
                    <script type="text/javascript" src="js/js/jquery.jplayer.min.js"></script>
                    <script type="text/javascript" src="js/js/jplayer.playlist.min.js"></script>
                    <script type="text/javascript">
                        //<![CDATA[
                        $(document).ready(function(){
            ...
            <div class="review-slider">
                ...
                <ul id="flexiselDemo1">
                    @foreach($artists as $artist)
                        <li>
                            <a href="single.html"><img width="100px" src="{{asset('storage/'.$artist->image)}}" alt=""/></a>
                    ...
                    @endforeach
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v1.jpg" alt=""/></a>--}}
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v2.jpg" alt=""/></a>--}}
                        {{--<div class="slide-title"><h4>Adele21</h4></div>--}}
                        {{--<div class="date-city">--}}
                            {{--<h5>Jan-02-16</h5>--}}
                            {{--<div class="buy-tickets">--}}
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v3.jpg" alt=""/></a>--}}
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v4.jpg" alt=""/></a>--}}
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v5.jpg" alt=""/></a>--}}
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v6.jpg" alt=""/></a>--}}
                    ...
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="single.html"><img src="../storage/images/v6.jpeg" alt=""/></a>--}}
