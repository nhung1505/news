		...
		<!--//pop-up-box -->
			<div class="albums">
				<div class="tittle-head">
					...
					<a href=""><h4 class="tittle">See all</h4></a>
					<div class="clearfix"></div>
				</div>
				@foreach($songs as $song)
					<div class="col-md-3 content-grid">
					<div class="css-image">
						<a href="{{route('song.details_song', $song->id)}}"><img src="{{asset('storage/'.$song->image)}}" title="song-name"></a>
					</div>
		...
		<!--//End-albums-->
			...
			<div class="albums second col-md-12">
				...
				@foreach($albums as $album)
					<div class="col-md-3 content-grid">
						<div class="css-image">
							<a href="{{route('album.detail_album', $album->id)}}"><img src="{{asset('storage/'.$album->image)}}" title="allbum-name"></a>
						</div>
						<div class="inner-info">
							<a href="{{route('album.detail_album', $album->id)}}">
							<h5>{{$album->name}}</h5>
							</a>
						</div>
					</div>
